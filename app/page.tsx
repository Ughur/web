...
export default function Home() {
  return (
    <section className='relative h-svh'>
      <div className='container mx-auto px-4 pt-45 md:pt-30  z-10'>
        <div className='flex flex-col lg:flex-row items-center justify-between gap-10'>
          <div className='space-y-8 relative z-20'>
            <div className='space-y-4'>
              <div className='flex gap-4 items-center'>
                <Terminal className='text-accent-green w-10 h-10' />
                <Code className='text-accent-fuchsia w-10 h-10' />
                <Cpu className='text-accent-amber w-10 h-10' />
              </div>
            ...
            <p className='body-text text-xl md:text-2xl max-w-2xl text-accent-green'>
